...
<div :class="cardClass" class="base-card">
    <router-link :to="'/recipe/' + id">
        <div class="image-container">
            <img :class="height" class="w-full transition-all delay-150 ease-linear active:opacity-50 hover:opacity-50" :src="'http://localhost:3080/' + image">
...
<style scoped>
    ...
    .base-card{
        @apply rounded-2xl relative mb-10;
    }
    ...
    .image-container{
        /* rounded-2xl flex justify-items-center items-center overflow-hidden;*/
        @apply rounded-lg flex justify-items-center items-center overflow-hidden relative;
        overflow: hidden;
    }
